...
const words = [
  ...
  { text: "Theory", imgPath: "/images/concepts.svg" },
...
const counterItems = [
  { value: "Engineering Physics", suffix: " ", label: "Engineering Beyond One Domain" },
  { value: "UBC Rocket", suffix: " ", label: "Firmware & Embedded Systems" },
  { value: 89.8, suffix: "%", label: "Cumulative Engineering Average" },
  { value: "Real Projects", suffix: " ", label: "From Idea to Deployment" },
];
